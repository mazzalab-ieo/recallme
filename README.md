...
![](https://img.shields.io/static/v1?label=Dependencies&message=singularity&color=lightgrey)
![](https://img.shields.io/static/v1?label=Dependencies&message=annovar&color=lightgrey)
